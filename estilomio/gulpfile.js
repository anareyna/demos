...
gulp.task('browserSync', function(){
	return browserSync({
		notify: true,
		proxy: "localhost/demos/estilomio/dist"
	});
});
...
gulp.task('watch', function() {
	...
	gulp.watch([path.stylusFiles],['stylus', reload]);
	gulp.watch([path.coffeeFiles], ['coffee', reload]);
});
